...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    KC_BRID, KC_BRIU,       KC_LCTL, KC_LGUI, MO(_FN1),KC_LALT, KC_SPC,           KC_SPC,  KC_SPC,  KC_RALT, MO(_FN2),KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FN1] = LAYOUT_65_with_macro(
    ...
    _______, _______,       _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_4,    KC_5,    KC_6,    _______, _______, _______,          _______, KC_HOME, \
    KC_F2,   KC_F3,         _______, _______, _______, _______, _______, _______, KC_1,    KC_2,    KC_3,    _______, _______, _______,          _______, KC_END, \
    KC_F11,  KC_F12,        _______, _______, _______, _______, _______,          KC_0,    KC_0,    KC_DOT,  KC_PLUS, KC_MINS,          _______, _______, _______
  ),
  ...
  [_FN2] = LAYOUT_65_with_macro(
    ...
    KC_F2,   KC_F3,         _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_END, \
