...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    KC_GESC, KC_PSCREEN,    KC_GRAVE, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  _______, KC_BSPC, KC_DEL, \
    ...
    KC_VOLD, KC_BRID,       KC_LCTL,  KC_LGUI, MO(_FN1),KC_LALT, KC_SPC,           KC_SPC,  KC_SPC,  KC_RALT, MO(_FN2),KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
  ),
